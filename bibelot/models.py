...
class Bibelot(models.Model):
    ...
    owner = models.ForeignKey('auth.User', related_name='bibelots', on_delete=models.CASCADE) # new
    ...
    def save(self, *args, **kwargs): # new
        ...
        representation of the code bibelot.
        """
        ...
        super(Bibelot, self).save(*args, **kwargs)
